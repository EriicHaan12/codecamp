...
const getCoffee = () => {
  ...
  createMenuCard2({ name: '아인슈페너', kcal: 125 }
  )
  createMenuCard3({ nname: '아이스라떼', kcal: 50 }
  )
  createMenuCard4({ name: '카라멜 마끼야또',kcal: 75 }
  )
  createMenuCard5({ name: '자바칩 프라프치노',kcal: 200 }
  )
  createMenuCard6({ name: '요거트 스무디', kcal: 150 }
  )
  createMenuCard7({ name: '아이스티', kcal: 80 }
  )
  createMenuCard8({ name: '오늘의 커피', kcal: 25 }
  )
  createMenuCard9({ name: '루왁 커피',  kcal: 30 }
  )
  createMenuCard10({ name: '콜드 브루', kcal: 20 }
  )
}
